...
you grant a person standing permission and they write without a request charge. The
...
A person you accept & Writes with no request charge. & You accept the relationship; you
revoke it. \\
An organization you chose & Travels an express lane with no request charge, bounded in purpose
...
grant creates no charge and settles no separate request.
...
Express lanes complete the permission model: strangers submit a relationship
request, accepted contacts write without a request charge, and chosen
organizations use a bounded grant. Each path reflects a different relationship
and gives the recipient a clear way to end it. Reaching the recipient depends
on permission they granted and can withdraw.
