...
a request to Bob. She sends permitted follow-ups without another charge and sees
...
3 & Alice requests a relationship & One conditional charge and encrypted submission \\
...
With funded service available, Alice resolves Bob and reviews $C$, $S$, the total
...
Expose the recipient's collateral menu and default with authenticated preference
updates. Changing a selection affects the next quote, leaving already authorized
