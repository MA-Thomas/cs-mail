...
Recipients can publish up to eight classes of their own at that boundary, with collateral selected for each from the deployment's bounded menu. The sender chooses a class and authorizes its fixed terms. These entry points describe invitations to approach; they are not permission grants or permanent kinds of relationship.
